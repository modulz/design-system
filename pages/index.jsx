  ...
  <path fill-rule="evenodd" clip-rule="evenodd" d="M2.5 4C2.22386 4 2 4.22386 2 4.5C2 4.77614 2.22386 5 2.5 5H12.5C12.7761 5 13 4.77614 13 4.5C13 4.22386 12.7761 4 12.5 4H2.5ZM2 7.5C2 7.22386 2.22386 7 2.5 7H12.5C12.7761 7 13 7.22386 13 7.5C13 7.77614 12.7761 8 12.5 8H2.5C2.22386 8 2 7.77614 2 7.5ZM2 10.5C2 10.2239 2.22386 10 2.5 10H12.5C12.7761 10 13 10.2239 13 10.5C13 10.7761 12.7761 11 12.5 11H2.5C2.22386 11 2 10.7761 2 10.5Z" fill="currentColor"/>
      ...
      <Box css={{ position: 'fixed', top: '0', left: '0', bottom: '0', width: 250, borderRight: '1px solid $gray500', oy: 'scroll', py: '$1' }}>
        ...
        <MenuItem css={{ backgroundColor: '$blue200', pl: 45 }}>
          ...
          <Text size={1}>Track</Text>
        </MenuItem>
        <MenuItem css={{ backgroundColor: '$blue300', pl: 75 }}>
          <Box css={{ mr: '$2' }}>
            <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd" clip-rule="evenodd" d="M10.5 4C8.567 4 7 5.567 7 7.5C7 9.433 8.567 11 10.5 11C12.433 11 14 9.433 14 7.5C14 5.567 12.433 4 10.5 4ZM7.67133 11C6.65183 10.175 6 8.91363 6 7.5C6 6.08637 6.65183 4.82498 7.67133 4H4.5C2.567 4 1 5.567 1 7.5C1 9.433 2.567 11 4.5 11H7.67133ZM0 7.5C0 5.01472 2.01472 3 4.5 3H10.5C12.9853 3 15 5.01472 15 7.5C15 9.98528 12.9853 12 10.5 12H4.5C2.01472 12 0 9.98528 0 7.5Z" fill="#282B2E"/>
            </svg>
          </Box>
          <Text size={1}>Thumb</Text>
        </MenuItem>
        <MenuItem>
          <Box css={{ mr: '$2' }}>
            <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <MenuItem css={{ backgroundColor: '$violet200', pl: 75 }}>
          <Box css={{ mr: '$2' }}>
            <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd" clip-rule="evenodd" d="M10.5 4C8.567 4 7 5.567 7 7.5C7 9.433 8.567 11 10.5 11C12.433 11 14 9.433 14 7.5C14 5.567 12.433 4 10.5 4ZM7.67133 11C6.65183 10.175 6 8.91363 6 7.5C6 6.08637 6.65183 4.82498 7.67133 4H4.5C2.567 4 1 5.567 1 7.5C1 9.433 2.567 11 4.5 11H7.67133ZM0 7.5C0 5.01472 2.01472 3 4.5 3H10.5C12.9853 3 15 5.01472 15 7.5C15 9.98528 12.9853 12 10.5 12H4.5C2.01472 12 0 9.98528 0 7.5Z" fill="#282B2E"/>
            </svg>
          </Box>
          <Text size={1}>Checkmark</Text>
        </MenuItem>
        <MenuItem css={{ backgroundColor: '$violet200', pl: 100 }}>
          <Box css={{ mr: '$2' }}>
            <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd" clip-rule="evenodd" d="M3.5 2C3.22386 2 3 2.22386 3 2.5V4C3 4.27614 3.22386 4.5 3.5 4.5C3.77614 4.5 4 4.27614 4 4V3H7V11H6C5.72386 11 5.5 11.2239 5.5 11.5C5.5 11.7761 5.72386 12 6 12H7.5H9C9.27614 12 9.5 11.7761 9.5 11.5C9.5 11.2239 9.27614 11 9 11H8V3H11V4C11 4.27614 11.2239 4.5 11.5 4.5C11.7761 4.5 12 4.27614 12 4V2.5C12 2.22386 11.7761 2 11.5 2H7.5H3.5Z" fill="#282B2E"/>
            </svg>
        ...
        <MenuItem css={{ backgroundColor: '$green200', pl: 45 }}>
          ...
          <Text size={1}>DialogTrigger</Text>
        </MenuItem>
        <MenuItem css={{ backgroundColor: '$green200', pl: 75 }}>
          <Box css={{ mr: '$2' }}>
            <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd" clip-rule="evenodd" d="M10.5 4C8.567 4 7 5.567 7 7.5C7 9.433 8.567 11 10.5 11C12.433 11 14 9.433 14 7.5C14 5.567 12.433 4 10.5 4ZM7.67133 11C6.65183 10.175 6 8.91363 6 7.5C6 6.08637 6.65183 4.82498 7.67133 4H4.5C2.567 4 1 5.567 1 7.5C1 9.433 2.567 11 4.5 11H7.67133ZM0 7.5C0 5.01472 2.01472 3 4.5 3H10.5C12.9853 3 15 5.01472 15 7.5C15 9.98528 12.9853 12 10.5 12H4.5C2.01472 12 0 9.98528 0 7.5Z" fill="#282B2E"/>
            </svg>
        ...
        <MenuItem css={{ backgroundColor: '$green200', pl: 45 }}>
          ...
          <Text size={1}>DialogOverlay</Text>
        </MenuItem>
        <MenuItem css={{ backgroundColor: '$green200', pl: 45 }}>
          <Box css={{ mr: '$2' }}>
            <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <Text size={1}>DialogContent</Text>
        </MenuItem>
        <MenuItem css={{ backgroundColor: '$green200', pl: 75 }}>
          <Box css={{ mr: '$2' }}>
            <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
