...
function App() {
  return (
    // className={darkTheme}
    <Box className={darkTheme} css={{ minHeight: '100%' }}>
      <Box css={{ position: 'absolute', top: 0, left: 0, width: '100%', backgroundColor: 'loContrast', py: 2, borderBottom: '1px solid', borderBottomColor: 'gray300' }}>
        <Flex css={{ justifyContent: 'space-between', px: 2 }}>
          <Flex>
            <IconButton variant="ghost">
              <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M4.5 14.5V0.5L12.5 7.5L4.5 14.5Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
            </IconButton>
      ...
      <Flex css={{ height: '100%' }}>
        <Box css={{ position: 'absolute', top: '46px', left: 0, bottom: 0, width: '250px', backgroundColor: 'loContrast', borderRightWidth: '1px', borderRightStyle: 'solid', borderColor: 'canvas' }}>
        <TreeItem css={{ px: 4 }}>
        ...
        <TreeItem css={{ px: 4 }}>
          <Box css={{ color: 'gray500' }}>
            <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M0.5 7.5H4.5" stroke="currentColor" stroke-linecap="round"/>
              <path d="M10.5 7.5H14.5" stroke="currentColor" stroke-linecap="round"/>
            </svg>
          </Box>
          <Text css={{ ml: 2, color: 'inherit' }}>Flex</Text>
        </TreeItem>
        <TreeItem css={{ px: 4 }}>
          <Box css={{ color: 'gray500' }}>
            <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M12.5 4.5V2.5H2.5V4.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M4.5 12.5H10.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M7.5 12.5V2.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </Box>
          <Text css={{ ml: 2, color: 'inherit' }}>Flex</Text>
        </TreeItem>
        <TreeItem css={{ px: 4 }}>
          ...
          <Box css={{ color: 'gray500', mr: 2 }}>
            <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
              <circle cx="7.5" cy="7.5" r="6" stroke="currentColor"/>
              <path d="M9.5 5.5L6.83333 9.5L5.5 8.13736" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </Box>
            Flex
          </TreeItem>
          ...
          <TreeItem css={{ px: 4 }}>
            <Box css={{ color: 'gray500' }}>
              <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15" fill="none">
                <path d="M3.5 5.5L1.5 7.5L3.5 9.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M11.5 5.5L13.5 7.5L11.5 9.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M5.03576 12.3143C4.9332 12.5707 5.05791 12.8617 5.3143 12.9642C5.5707 13.0668 5.86168 12.9421 5.96424 12.6857L5.03576 12.3143ZM9.96424 2.6857C10.0668 2.4293 9.94209 2.13832 9.6857 2.03576C9.4293 1.9332 9.13832 2.05791 9.03576 2.3143L9.96424 2.6857ZM5.96424 12.6857L9.96424 2.6857L9.03576 2.3143L5.03576 12.3143L5.96424 12.6857Z" fill="currentColor"/>
              </svg>
            </Box>
            <Text css={{ ml: 2, color: 'inherit' }}>Flex</Text>
          </TreeItem>
        ...
        <Box css={{ position: 'absolute', top: '46px', right: 0, bottom: 0, width: '250px', flexShrink: 0, backgroundColor: 'loContrast', borderLeftWidth: '1px', borderLeftStyle: 'solid', borderColor: 'canvas' }}>
          <Card css={{ p: 3, m: 3 }}>
            <Text as="p" size="2" css={{ lineHeight: '20px', mb: 1 }}>If possible, we should revert to our older syntax with a separate variant block.</Text>
            <Text as="p" size="2" css={{ lineHeight: '20px', color: 'gray600', mb: 2 }}>The current variant syntax is very confusing in long files.</Text>
            <Button>
              <Box css={{ mr: '1' }}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                  <path d="M3 8H13" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
      ...
      <Box css={{ position: 'absolute', top: '200px', left: '800px', bottom: 0, width: '375px', backgroundColor: 'white', height: '667px' }}></Box>

      <Box css={{ position: 'absolute', top: '400px', left: '1400px', bottom: 0, width: '160px', height: '250px', backgroundColor: 'loContrast', borderRadius: 2, boxShadow: '0 16px 32px -10px hsl(206deg 12% 5% / 25%), 0 8px 16px -15px hsl(0deg 0% 0% / 10%)' }}></Box>
    </Box>
  );
}
