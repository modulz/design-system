...
export const theme = {
  colors: {
    ...
    $red600: 'hsl(353,90%,70%)',
    $red700: 'hsl(357,100%,65%)',
    ...
    $crimson500: 'hsl(340,100%,68%)',
    $crimson600: 'hsl(340,79%,65%)',
    $crimson700: 'hsl(340,80%,54%)',
    $crimson800: 'hsl(340,80%,52%)',
    $crimson900: 'hsl(340,79%,48%)',
    ...
    $violet800: 'hsl(252,78%,60%)',
    $violet900: 'hsl(252,80%,53%)',
