...
export const theme = {
  colors: {
    ...
    $crimson400: 'hsl(336,90%,92%)',
    $crimson500: 'hsl(336,100%,85%)',
    $crimson600: 'hsl(336,79%,76%)',
    $crimson700: 'hsl(336,80%,70%)',
    $crimson800: 'hsl(336,88%,56%)',
    $crimson900: 'hsl(336,79%,48%)',

    $pink100: 'hsl(327,100%,99%)',
    $pink200: 'hsl(327,100%,98%)',
    $pink300: 'hsl(327,100%,94%)',
    $pink400: 'hsl(327,75%,92%)',
    $pink500: 'hsl(327,95%,83%)',
    $pink600: 'hsl(327,80%,76%)',
    $pink700: 'hsl(327,100%,70%)',
    $pink800: 'hsl(327,86%,58%)',
    $pink900: 'hsl(327,80%,53%)',
